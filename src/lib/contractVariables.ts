...
export const CONTRACT_VARIABLES: ContractVariableDefinition[] = [
  ...
  { tag: "{{client_identification}}", label: "Client Identification Block", description: "Structured client details (name, tax ID, email, phone, address).", example: "Name, Tax ID, Email…", group: "Client" },
  { tag: "{{freelancer_identification}}", label: "Freelancer Identification Block", description: "Structured service provider details (company, representative, tax ID, contact).", example: "Company, Tax ID, Email…", group: "Freelancer" },
